...
<?php } if ($this->_rootref['S_DISPLAY_POST_INFO']) {  ?>
		...
		<table class='icons' cellspacing="0">
			<tr>
				<td width="5%" nowrap="nowrap">
					<?php echo (isset($this->_rootref['FOLDER_NEW_IMG'])) ? $this->_rootref['FOLDER_NEW_IMG'] : ''; ?> &nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_NEW_POSTS'])) ? $this->_rootref['L_NEW_POSTS'] : ((isset($user->lang['NEW_POSTS'])) ? $user->lang['NEW_POSTS'] : '{ NEW_POSTS }')); ?></span>
					<br /><?php echo (isset($this->_rootref['FOLDER_HOT_NEW_IMG'])) ? $this->_rootref['FOLDER_HOT_NEW_IMG'] : ''; ?>&nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_NEW_POSTS_HOT'])) ? $this->_rootref['L_NEW_POSTS_HOT'] : ((isset($user->lang['NEW_POSTS_HOT'])) ? $user->lang['NEW_POSTS_HOT'] : '{ NEW_POSTS_HOT }')); ?></span>
					<br /><?php echo (isset($this->_rootref['FOLDER_LOCKED_NEW_IMG'])) ? $this->_rootref['FOLDER_LOCKED_NEW_IMG'] : ''; ?>&nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_NEW_POSTS_LOCKED'])) ? $this->_rootref['L_NEW_POSTS_LOCKED'] : ((isset($user->lang['NEW_POSTS_LOCKED'])) ? $user->lang['NEW_POSTS_LOCKED'] : '{ NEW_POSTS_LOCKED }')); ?></span>
				</td>
					<td width="5%" nowrap="nowrap">
					<?php echo (isset($this->_rootref['FOLDER_IMG'])) ? $this->_rootref['FOLDER_IMG'] : ''; ?> &nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_NO_NEW_POSTS'])) ? $this->_rootref['L_NO_NEW_POSTS'] : ((isset($user->lang['NO_NEW_POSTS'])) ? $user->lang['NO_NEW_POSTS'] : '{ NO_NEW_POSTS }')); ?></span>
					<br /><?php echo (isset($this->_rootref['FOLDER_HOT_IMG'])) ? $this->_rootref['FOLDER_HOT_IMG'] : ''; ?>&nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_NO_NEW_POSTS_HOT'])) ? $this->_rootref['L_NO_NEW_POSTS_HOT'] : ((isset($user->lang['NO_NEW_POSTS_HOT'])) ? $user->lang['NO_NEW_POSTS_HOT'] : '{ NO_NEW_POSTS_HOT }')); ?></span>
					<br /><?php echo (isset($this->_rootref['FOLDER_LOCKED_IMG'])) ? $this->_rootref['FOLDER_LOCKED_IMG'] : ''; ?>&nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_NO_NEW_POSTS_LOCKED'])) ? $this->_rootref['L_NO_NEW_POSTS_LOCKED'] : ((isset($user->lang['NO_NEW_POSTS_LOCKED'])) ? $user->lang['NO_NEW_POSTS_LOCKED'] : '{ NO_NEW_POSTS_LOCKED }')); ?></span>
				</td>
					<td width="5%" nowrap="nowrap">
					<?php echo (isset($this->_rootref['FOLDER_ANNOUNCE_IMG'])) ? $this->_rootref['FOLDER_ANNOUNCE_IMG'] : ''; ?> &nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_ICON_ANNOUNCEMENT'])) ? $this->_rootref['L_ICON_ANNOUNCEMENT'] : ((isset($user->lang['ICON_ANNOUNCEMENT'])) ? $user->lang['ICON_ANNOUNCEMENT'] : '{ ICON_ANNOUNCEMENT }')); ?></span>
					<br /><?php echo (isset($this->_rootref['FOLDER_STICKY_IMG'])) ? $this->_rootref['FOLDER_STICKY_IMG'] : ''; ?>&nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_ICON_STICKY'])) ? $this->_rootref['L_ICON_STICKY'] : ((isset($user->lang['ICON_STICKY'])) ? $user->lang['ICON_STICKY'] : '{ ICON_STICKY }')); ?></span>
					<br /><?php echo (isset($this->_rootref['FOLDER_MOVED_IMG'])) ? $this->_rootref['FOLDER_MOVED_IMG'] : ''; ?>&nbsp;<span class="desc"><?php echo ((isset($this->_rootref['L_TOPIC_MOVED'])) ? $this->_rootref['L_TOPIC_MOVED'] : ((isset($user->lang['TOPIC_MOVED'])) ? $user->lang['TOPIC_MOVED'] : '{ TOPIC_MOVED }')); ?></span>
				</td>
	...
	<table width="100%" cellspacing="0">
<tr>
	<td align="left"><span class="gensmall"><?php $_rules_count = (isset($this->_tpldata['rules'])) ? sizeof($this->_tpldata['rules']) : 0;if ($_rules_count) {for ($_rules_i = 0; $_rules_i < $_rules_count; ++$_rules_i){$_rules_val = &$this->_tpldata['rules'][$_rules_i]; echo $_rules_val['RULE']; ?><br /><?php }} ?></span></td>
	</tr>
		<tr>
	<td align="right">
				<?php if ($this->_rootref['S_DISPLAY_SEARCHBOX']) {  $this->_tpl_include('searchbox.html'); } ?> <br />
